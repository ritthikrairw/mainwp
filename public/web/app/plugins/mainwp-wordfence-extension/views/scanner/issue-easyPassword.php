...
echo MainWP_wfView::create('scanner/issue-base', array(
	...
	'summaryControls' => array(MainWP_wfView::create('scanner/issue-control-edit-user'), MainWP_wfView::create('scanner/issue-control-ignore', array('ignoreP' => __('Ignore All for User', 'wordfence'), 'ignoreC' => __('Ignore Only this Password', 'wordfence'))), MainWP_wfView::create('scanner/issue-control-show-details')),
	'detailPairs' => array(
