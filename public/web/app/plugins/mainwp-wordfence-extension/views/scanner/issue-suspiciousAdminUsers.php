...
echo MainWP_wfView::create('scanner/issue-base', array(
	...
	'summaryControls' => array(MainWP_wfView::create('scanner/issue-control-ignore', array('ignoreP' => __('Ignore', 'wordfence'))), MainWP_wfView::create('scanner/issue-control-show-details')),
	'detailPairs' => array(
		__('Details', 'wordfence') => '{{html longMsg}}',
	),
	'detailControls' => array(
		'<a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle" onclick="MWP_WFAD.deleteAdminUser(\'${id}\',' . intval($site_id). '); return false;">' . __('Delete User', 'wordfence') . '</a>',
		'<a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle" onclick="MWP_WFAD.revokeAdminUser(\'${id}\',' . intval($site_id). '); return false;">' . __('Revoke Capabilities', 'wordfence') . '</a>',
