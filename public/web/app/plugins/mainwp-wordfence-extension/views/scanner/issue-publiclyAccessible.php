...
echo MainWP_wfView::create('scanner/issue-base', array(
	...
	'summaryControls' => array(MainWP_wfView::create('scanner/issue-control-hide-file'), MainWP_wfView::create('scanner/issue-control-ignore', array('ignoreC' => __('Ignore', 'wordfence'))), MainWP_wfView::create('scanner/issue-control-show-details')),
	'detailPairs' => array(
