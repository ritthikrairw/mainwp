...
echo MainWP_wfView::create('scanner/issue-base', array(
	...
	'summaryControls' => array(MainWP_wfView::create('scanner/issue-control-ignore'), MainWP_wfView::create('scanner/issue-control-show-details')),
	'detailPairs' => array(
	...
	'detailControls' => array(
		...
		'{{if data.canDelete}}<a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle" onclick="MWP_WFAD.deleteFile(\'${id}\', ' . intval($site_id). '); return false;">' . __('Delete File', 'wordfence') . '</a>{{/if}}',
		'<a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle" onclick="MWP_WFAD.updateIssueStatus(\'${id}\', \'delete\', null, ' . intval($site_id). '); return false;">' . __('Mark as Fixed', 'wordfence') . '</a>',
	)
))->render();
