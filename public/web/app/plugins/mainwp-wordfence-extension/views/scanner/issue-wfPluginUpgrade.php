...
echo MainWP_wfView::create('scanner/issue-base', array(
	...
	'summaryControls' => array(MainWP_wfView::create('scanner/issue-control-ignore', array('ignoreC' => __('Ignore Update', 'wordfence'))), MainWP_wfView::create('scanner/issue-control-show-details')),
	'detailPairs' => array(
		...
		null,
		__('Details', 'wordfence') => '{{if data.vulnerable}}<strong>' . __('Update includes security-related fixes.', 'wordfence') . '</strong><br>{{/if}}{{html longMsg}}<br><a href="' . esc_url($update_url) . '">' . __('Click here to update now', 'wordfence') . '</a>.',
		null,
	...
	'detailControls' => array(
		...
		'<a href="' . esc_url($update_url) . '" class="wf-btn wf-btn-default wf-btn-callout-subtle wf-issue-control-view-updates" target="_blank">' . __('View Updates', 'wordfence') . '</a>',
	)
))->render(); 
