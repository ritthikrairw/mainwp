...
echo MainWP_wfView::create('scanner/issue-base', array(
	...
	'summaryControls' => array(MainWP_wfView::create('scanner/issue-control-edit-post'), MainWP_wfView::create('scanner/issue-control-ignore', array('ignoreP' => __('Always Ignore', 'wordfence'), 'ignoreC' => __('Ignore Only this Title', 'wordfence'))), MainWP_wfView::create('scanner/issue-control-show-details')),
	'detailPairs' => array(
