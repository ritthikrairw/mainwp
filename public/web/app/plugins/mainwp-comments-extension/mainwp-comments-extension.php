...
class MainWP_Comments_Extension {
	...
	static function get_instance() {
		...
		if ( null == self::$instance ) {
			self::$instance = new MainWP_Comments_Extension();
		}
	...
	public function admin_init() {
		...
		$ajax_search = MainWP_Comment::get_instance()->secure_request( 'mainwp_comments_search', 'security', false );

		if ( $ajax_search || ( isset( $_GET['page'] ) && 'Extensions-Mainwp-Comments-Extension' == $_GET['page'] ) ) {
			MainWP_Comment_Utility::init_session();
		}

		$nonce = wp_create_nonce( 'mainwp_comments_nonce' );
