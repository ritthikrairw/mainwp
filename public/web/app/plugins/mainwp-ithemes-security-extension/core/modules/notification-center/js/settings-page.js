jQuery( document ).ready(function($) {
	jQuery( function ( $ ) {
		...
		$( document ).on( 'itsec-dismiss-notice', '.itsec-notification-center-mail-errors-container .notice.itsec-is-dismissible', function () {
			...
			mainwp_itsecSettingsPage.sendModuleAJAXRequest( 'notification-center', { method: 'dismiss-mail-error', mail_error: errorId }, function ( r ) {
		...
		mainwp_itsecSettingsPage.events.on( 'modulesReloaded', initializeHiding );
		mainwp_itsecSettingsPage.events.on( 'moduleReloaded', function ( _, module ) {
