...
/**
 * Class MainWP_ITSEC_Password_Requirements_Validator
 */
class MainWP_ITSEC_Password_Requirements_Validator extends MainWP_ITSEC_Validator {
	...
	protected function sanitize_settings() {
		$this->sanitize_setting( 'array', 'enabled_requirements', __( 'Enabled Requirements', 'l10n-mainwp-ithemes-security-extension' ) );
		$this->sanitize_setting( 'array', 'requirement_settings', __( 'Requirement Settings', 'l10n-mainwp-ithemes-security-extension' ) );
...
MainWP_ITSEC_Modules::register_validator( new MainWP_ITSEC_Password_Requirements_Validator() );