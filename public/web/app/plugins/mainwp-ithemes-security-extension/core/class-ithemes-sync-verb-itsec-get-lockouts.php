...
class MainWP_Ithemes_Sync_Verb_ITSEC_Get_Lockouts extends MainWP_Ithemes_Sync_Verb {
	...
	public function run( $arguments ) {
		...
		$lockouts = $mainwp_itsec_lockout->get_lockouts( 'all', true ); // Gets all lockouts, host and user
