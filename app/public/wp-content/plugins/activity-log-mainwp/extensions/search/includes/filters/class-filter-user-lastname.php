 ...
 */
class Filter_User_Lastname extends Abstract_Filter {
	...
	public function get_widgets() {
		return array( new Widget_User_Lastname( 'lastname', 'Last Name' ) );
	}
	...
	public function modify_query( $query, $prefix, $value ) {
		...
		$sql   = "$table_occ.id IN ( SELECT occurrence_id FROM $table_meta as meta WHERE meta.name='LastName' AND ( ";
		$count = count( $value );
